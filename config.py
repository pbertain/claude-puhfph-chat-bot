...
# Troubleshooting web UI auth
# Set TROUBLESHOOTING_TOKEN to enable token auth
# Set TROUBLESHOOTING_USER/TROUBLESHOOTING_PASS to enable basic auth
TROUBLESHOOTING_TOKEN = ""
TROUBLESHOOTING_USER = ""
